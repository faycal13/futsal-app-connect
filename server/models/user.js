...
const UserSchema = new Schema({
    name:{type: String,  require: true, trim: true},//trim allows you to remove the blanks at the beginning and end of the String. (space, tab, unbreakable space, etc.)
...
// Generate img with api gravatar
